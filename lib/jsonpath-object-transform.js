...
(function (root, factory) {
  ...
  jsonPath.JSONPath.Handlers.prototype._fns['subscript-descendant-script_expression'] = function(component,partial) {
    ...
    return partial.value.map(function(val,idx) {
      return {path: partial.path.concat([idx, component.expression.value ]), value: evaluate(ast, { '@': val, 'toupper' : function(x) { return x.toUpperCase(); } }) };
    });
  };
